  ...
  return (
    <section className="p-10 border border-slate-600 rounded-xl shadow-sm mb-8">
      <div className="flex gap-8 items-center flex-wrap md:flex-nowrap">
        <div
          className="w-40 h-40 rounded-full bg-cover bg-center border-4 border-emerald-400"
        ...
        <div className="flex-1">
          ...
          {member.bio && (
            <p className="text-slate-400 max-w-lg mb-4">{member.bio}</p>
          )}
      ...
      hover:bg-emerald-500 transition duration-300"
              >
                Download Resume
              </a>
            )}
